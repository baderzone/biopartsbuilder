class Protocol < ActiveRecord::Base
  ...
  attr_accessible :construct_size, :name, :overlap_list, :overlap_size, :ext_prefix, :forbid_enzymes, :ext_suffix, :int_prefix, :int_suffix, :organism, :organism_id, :check_enzymes, :comment, :lab, :lab_id
