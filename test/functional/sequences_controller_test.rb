...
class SequencesControllerTest < ActionController::TestCase
  ...
  test "should create sequence" do
    assert_difference('Sequence.count') do
      post :create, sequence: { accession: @sequence.accession, annotation: @sequence.annotation, organism_id: @sequence.organism_id, part_id: @sequence.part_id, seq: @sequence.seq }
    end
  ...
  test "should update sequence" do
    put :update, id: @sequence, sequence: { accession: @sequence.accession, annotation: @sequence.annotation, organism_id: @sequence.organism_id, part_id: @sequence.part_id, seq: @sequence.seq }
    assert_redirected_to sequence_path(assigns(:sequence))
  end
